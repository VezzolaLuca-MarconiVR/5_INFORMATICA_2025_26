...
**_[APPROFONDIMENTO: Architettura multi-tier](Architettura%20multi-tier.md)_**
**_[APPROFONDIMENTO: AJAX](AJAX.md)_**
...
- **HTTP non è sicuro**. Le informazioni passano in chiaro e possono essere facilmente intercettate e lette. Le informazioni riservate devono essere crittografate., e il protocollo HTTPS (**_Secure HTTP_**) è stato creato apposta per fare ciò.

**_[APPROFONDIMENTO: Considerazioni sul protocollo HTTP](./Approfondimenti/considerazioni%20sul%20protocollo%20HTTP.md)_**
**_[APPROFONDIMENTO: API Restful](./Approfondimenti/API%20Restful.md)_**

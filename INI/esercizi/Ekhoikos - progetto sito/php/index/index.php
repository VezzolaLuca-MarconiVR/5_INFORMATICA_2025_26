...
<html lang="it">
  ...
  <body>
    ...
    <main>
      ...
      <!-- INTRO & GOALS -->
      <section class="covering-section center-both primary-muted-bg">
        <div class="section-wrapper padding-sides light-bg rounded-corners">
          <h1>Cos'è <b>Ekhoikos</b>?</h1>
          <p>
          ...
          <ol class="vertical-small-margin-children">
            <li>
              <h3 class="rounded-corners"><b>"CHILOMETRO ZERO"</b><br /></h3>
              <p>
            ...
            <li>
              <h3 class="rounded-corners"><b>PRODOTTI SOSTENIBILI</b><br /></h3>
              <p>
            ...
            <li>
              <h3 class="rounded-corners">
                <b>SOSTEGNO VERSO LE FONDAZIONI</b><br />
              </h3>
              <p>
      ...
      <!-- Impatto Ambientale del Trasporto Merci -->
      <section id="hero-containers" class="covering-section hero center-both">
        <div class="section-wrapper center-x center-y higlight-color">
          <h3 class="dark-bg-transparent padding rounded-corners">
          ...
          <p class="padding rounded-corners">Grazie - dal team di Ekhoikos.</p>
        </div>
      </section>

      <section class="center-both padding-top-bottom">
        <div class="section-wrapper center-x center-y margin-top">
          <h1>Introduzione - Un <i>Ekho</i> dal nostro <i>Oikos</i></h1>
          <span>
          ...
          <span>
            ...
            <b>Trasporto su strada (camion):</b> Contribuisce da solo a circa il
            24% delle emissioni di CO2 del settore trasporti in Italia,
            risultando la modalità più impattante sotto il profilo carbonico. -
            <b>Trasporto marittimo:</b> È efficiente per quantità, ma risulta
            responsabile di quasi il 3% delle emissioni globali di gas serra,
            con una significativa incidenza locale in prossimità dei porti. -
          ...
          <table id="freightTransportTable">
            <thead>
              <tr>
          ...
          <span>
            ...
            reti sempre più alimentate da fonti rinnovabili. Il
            <b>marittimo</b> è fondamentale per i grandi volumi e il trasporto
            intercontinentale, ma va sottolineato che le sue emissioni locali
            incidono gravemente sulle aree portuali, mentre a livello globale la
            sua efficienza è superiore al trasporto stradale per ogni
            tonnellata*km. L’<b>aereo</b> è residuale nei volumi ma estremamente
            impattante in termini specifici di emissioni per chilogrammo
            trasportato.
          </span>
        </div>
      </section>
      ...
      <section
        section
        id="hero-mountains"
        class="covering-section hero center-both"
      >
        <div
          class="section-wrapper dark-bg-transparent rounded-corners center-x center-y padding"
        >
          <h1>Conclusioni</h1>
          <span>
            ...
            <b
              >Promuovere la riduzione delle distanze nei trasporti, favorendo
              il chilometro zero e rilocalizzando le filiere produttive</b
          ...
          <span>
            L’evidenza è chiara:
            <b
              >meno chilometri percorsi dalle merci equivalgono a più salute,
              più ambiente e più valore per le economie locali</b
